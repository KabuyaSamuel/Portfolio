const Services = () => {
    return (
    //   <section id="services" className="sm:p-10 lg:p-20 p-5 min-h-screen">
        <div data-aos="fade-up" id="Services" className=" sm:container mx-auto">
          <h2  data-aos="fade-up" className="text-center text-4xl font-bold pt-10 sm:pt-0 pb-10 text-fuchsia-500" >Services</h2>
